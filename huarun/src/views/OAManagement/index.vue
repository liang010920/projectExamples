      ...
      <el-col :span="8">
        <div class="grid-content bg-purple-dark">
          ...
          <div class="item_index2">
            ...
            <div class="item u-f-column u-f-ac c-padding">
              <div class="u-f-ac"  @click="Is_show_member = true">
        ...
        <el-dialog title="导入人员信息" :visible.sync="Is_show_member">
          ...
          <div slot="footer" class="dialog-footer" style="clear:both">
            ...
            <el-button type="primary" @click="Is_show_member = false">保 存</el-button>
          </div>
        </el-dialog>
      </el-col>
    </el-row>
    ...
    methods: {
      ...
      sleep() {
        ...
        sleepEcharts.setOption({
          ...
          legend: {
            data: ['20:00-21:00', '22:00', '23:00-00:00', '01:00-02:00', '03:00'],
            x: 'center',
            y: '92%',
            textStyle: {
              color: '#000'
