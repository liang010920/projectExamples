    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="报警统计" name="first">
        <el-radio-group v-model="tabPosition" style="padding:0 20px 10px" @change="getData_tabPosition">
          ...
          <el-radio-button label="月" class="bgDay">月</el-radio-button>
        </el-radio-group>
        <el-date-picker v-if="tabPosition == '月'" v-model="value1" type="monthrange" :start-placeholder="dateStart"
          :end-placeholder="dateEnd" @change="getDateTime_Warn" placeholder="选择月"></el-date-picker>
        <el-date-picker v-if="tabPosition == '天'" v-model="value1" type="daterange" :start-placeholder="dateStart"
          :end-placeholder="dateEnd" @change="getDateTime_Warn" placeholder="选择日期"></el-date-picker>
        <div class="item_flex">
          <div class="blood_Pressure" style="background: #fff;margin: 0 22px;">
          ...
          <div class="item">
            ...
            <div class="block">
              <el-pagination layout="prev, pager, next" :page-size="pageSize" @current-change="getPageIndex"
                @prev-click="getPrevPage" @next-click="getNextPage" :total="totalRow"></el-pagination>
            </div>
          </div>
        </div>
      </el-tab-pane>
              ...
              <div class="grid-content bg-purple-dark">
                <el-form label-width="120px">
                  <el-form-item label="按评估状态查询">
                    <el-select v-model="value_select_option" @change="change_Warn_status(value_select_option)"
                      placeholder="请选择">
              ...
              <div class="grid-content bg-purple-dark">
                <el-form label-width="120px">
                  <el-form-item label="按报警通知查询">
                    <el-select v-model="value_select_police" @change="change_Police_status(value_select_police)"
                      placeholder="请选择">
      ...
      <el-tab-pane label="报警设置" name="setting">
              ...
              <el-col :span="9">
                <div class="grid-content bg-purple">
                  <el-form-item label="报警内容">
                    <el-input type="text" v-model="input_warnInfo[index]" readonly="readonly"></el-input>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
        ...
        <el-row>
          <el-col :span="14" style="text-align:center;margin-top:50px;">
            <div class="grid-content bg-purple">
              <el-button @click="reset_btn_warn()" style="padding: 15px 20px;">重置</el-button>
              <el-button type="primary" style="margin:0 30px;padding: 14px 17px;" @click="save_setting()">保存</el-button>
            </div>
          </el-col>
        </el-row>
      </el-tab-pane>
      ...
      <el-form ref="form" :model="form" label-width="120px">
        <el-row>
            ...
            <div class="grid-content bg-purple-dark">
              <el-form label-width="120px">
                <el-form-item label="人员名称">
                  <el-input v-model="memberName" readonly="readonly"></el-input>
                </el-form-item>
              </el-form>
            </div>
          </el-col>
          <el-col :span="4">
            <div class="grid-content bg-purple-dark" style="margin:5px 20px">
              <el-form label-width="120px">
                <el-button size="mini" type="primary" @click="GetMemberHealthList()">个人评估记录</el-button>
              </el-form>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="6">
            <div class="grid-content bg-purple-dark">
              <el-form label-width="120px">
                <el-form-item label="血压值">
                  <el-input v-model="blood_price" placeholder="血压值" readonly="readonly"></el-input>
                </el-form-item>
              </el-form>
            </div>
          </el-col>
          <el-col :span="6">
            <div class="grid-content bg-purple-dark">
              <el-form label-width="120px">
                <el-form-item label="心率值">
                  <el-input v-model="heart_price" placeholder="心率值" readonly="readonly"></el-input>
                </el-form-item>
              </el-form>
            </div>
          </el-col>
        ...
        <el-form-item label="人员通知">
          <el-input v-model="memberInform" readonly="readonly"></el-input>
        </el-form-item>
        ...
        <el-form-item label="人员评估">
          <el-input type="textarea" v-model="textarea_assess" :rows="7" placeholder="请给出人员评估"></el-input>
        </el-form-item>
      </el-form>
      ...
      <div>
        <el-form label-width="80px">
          <el-form-item label="医生名称">
            <el-input v-model="doctor_InputValue" placeholder="请填写人员名称"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    <el-dialog title="消息详情" :visible.sync="IS_show_warn">
      <el-form ref="form" :model="form" label-width="120px">
        <el-form-item label="设备名称">
          <el-input v-model="warnInfo.WarnDeviceName"></el-input>
        </el-form-item>
        <el-form-item label="消息内容">
          <el-input v-model="warnInfo.WarnIntro"></el-input>
        </el-form-item>
        <el-form-item label="预警人员">
          <el-input v-model="warnInfo.WarnMemberName"></el-input>
        </el-form-item>
        <el-form-item label="人员电话">
          <el-input v-model="warnInfo.WarnMemberTel"></el-input>
        </el-form-item>
      </el-form>
