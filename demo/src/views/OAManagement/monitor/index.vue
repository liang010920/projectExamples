<template>
  <div class="container">
    ...
    <div class="item_Navbar" v-if="Is_Show_Navbar">
      ...
      <h4 :class="{ h4_active: tabIndex == 3 }" @click="(tabIndex = 3), (Is_Show_Navbar = false), GetMemberDoctorList()" v-if="memberLoginType.MemberType == '9'">监护医生</h4>
    ...
    <div class="item_content" v-if="tabIndex == 1">
      <div class="content_title">
        <div class="title_search">
          ...
          <input type="text" placeholder="搜索" v-model="search_Input" />
        ...
        <ul>
          <li v-for="(item, index) in deviceList" :key="index" @click="open(item.ID)">
            ...
            <div class="content_item_Name" :class="['status' + item.MemberStatusHealth]">
              <div class="content_item_Name_img" :class="['status' + item.MemberStatusHealth]"><img src="./../../../../static/img/icon/1.png" alt /></div>
      ...
      <div class="Add_Object">
        ...
        <div class="item">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
            <el-form-item label="人员名称" prop="name"><el-input v-model="ruleForm.name" placeholder="请输入人员名称"></el-input></el-form-item>
            <el-form-item label="人员电话" prop="memberTel"><el-input type="number" v-model="ruleForm.memberTel" placeholder="请输入人员电话"></el-input></el-form-item>
            <el-form-item label="邮箱地址" prop="memberEmail"><el-input type="text" v-model="ruleForm.memberEmail" placeholder="请输入邮箱地址"></el-input></el-form-item>
            <el-form-item label="设备编号" prop="memberImei"><el-input type="number" v-model="ruleForm.memberImei" placeholder="请输入设备编号"></el-input></el-form-item>
            <el-form-item label="人员地址"><v-distpicker :province="memberArea1" :city="memberArea2" :area="memberArea3" @selected="onSelected"></v-distpicker></el-form-item>
            <el-form-item label="人员详细地址" prop="address"><el-input v-model="ruleForm.address" placeholder="请输入人员详细地址"></el-input></el-form-item>
            ...
            <el-form-item label="过往病史" prop="desc"><el-input type="textarea" v-model="ruleForm.desc" :rows="5" placeholder="请输入过往病史"></el-input></el-form-item>
            <el-form-item>
        ...
        <div class="item">
          <el-form label-width="120px" class="demo-ruleForm">
            <el-form-item label="紧急联系人"><el-input type="text" v-model="ruleForm.memberContactMan1Name" placeholder="紧急联系人"></el-input></el-form-item>
            <el-form-item label="紧急联系人电话"><el-input type="text" v-model="ruleForm.memberContactMan1Tel" placeholder="紧急联系人电话"></el-input></el-form-item>
            <el-form-item label="第二联系人"><el-input type="text" v-model="ruleForm.memberContactMan2Name" placeholder="第二联系人"></el-input></el-form-item>
            <el-form-item label="第二联系人电话"><el-input type="text" v-model="ruleForm.memberContactMan2Tel" placeholder="第二联系人电话"></el-input></el-form-item>
            <el-form-item label="监护医生:">
              <el-input placeholder="请搜索姓名" v-model="ruleForm.memberContactMan3Name" class="input-with-select" :disabled="true">
                <el-button slot="append" icon="el-icon-search" @click="(isShow = true), GetMemberDoctorList()"></el-button>
              </el-input>
            </el-form-item>
            <el-form-item label="监护医生电话"><el-input type="text" v-model="ruleForm.memberContactMan3Tel" placeholder="监护医生电话" :disabled="true"></el-input></el-form-item>
          </el-form>
        </div>
      </div>
    </div>
    <div class="item_content" v-if="tabIndex == 3 && memberLoginType.MemberType == '9'">
      ...
      <div class="block">
        <el-pagination
          layout="prev, pager, next"
          :page-size="pageSize_Doctor"
          @current-change="getPageIndex_Doctor"
          @prev-click="getPrevPage_Doctor"
          @next-click="getNextPage_Doctor"
          :total="totalRow_Doctor"
        ></el-pagination>
        <span style="margin:6px">共: {{ totalRow_Doctor }} /人</span>
      </div>
    </div>
    ...
    <el-dialog :visible.sync="IS_show_ECG">
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick2">
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="心率变化图(bpm)" name="first">
              <div class="day" v-if="tabPosition == '天'">
                <span>按天查询:</span>
                <el-date-picker v-model="value1" type="daterange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDateTime_ECG"></el-date-picker>
              </div>
              <div class="month" v-if="tabPosition == '月'">
                <span>按月查询:</span>
                <el-date-picker v-model="value1" type="monthrange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDateTime_ECG"></el-date-picker>
              </div>
              <el-radio-group v-model="tabPosition" style="margin:10px 10% 0 0;display: inline-block; float:right;" @change="getData_tabPosition">
            ...
            <el-tab-pane label="高血压变化图(mmHg)" name="second">
              <div class="day" v-if="tabPosition == '天'">
                <span>按天查询:</span>
                <el-date-picker v-model="value1" type="daterange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDateTime_Blood"></el-date-picker>
              </div>
              <div class="month" v-if="tabPosition == '月'">
                <span>按月查询:</span>
                <el-date-picker v-model="value1" type="monthrange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDateTime_Blood"></el-date-picker>
              </div>
              <el-radio-group v-model="tabPosition" style="margin:10px 10% 0 0;display: inline-block; float:right;" @change="getData_tabPosition">
                <el-radio-button label="天">天</el-radio-button>
                <el-radio-button label="月">月</el-radio-button>
            ...
            <el-tab-pane label="低血压变化图(mmHg)" name="third">
              <div class="day" v-if="tabPosition == '天'">
                <span>按天查询:</span>
                <el-date-picker v-model="value1" type="daterange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_lowBlood"></el-date-picker>
              </div>
              <div class="month" v-if="tabPosition == '月'">
                <span>按月查询:</span>
                <el-date-picker v-model="value1" type="monthrange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_lowBlood"></el-date-picker>
              </div>
              <el-radio-group v-model="tabPosition" style="margin:10px 10% 0 0;display: inline-block; float:right;" @change="getData_tabPosition">
                <el-radio-button label="天">天</el-radio-button>
                <el-radio-button label="月">月</el-radio-button>
            ...
            <el-tab-pane label="步数变化图(步)" name="fourth">
              <div class="day" v-if="tabPosition == '天'">
                <span>按天查询:</span>
                <el-date-picker v-model="value1" type="daterange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_step"></el-date-picker>
              </div>
              <div class="month" v-if="tabPosition == '月'">
                <span>按月查询:</span>
                <el-date-picker v-model="value1" type="monthrange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_step"></el-date-picker>
              </div>
              <el-radio-group v-model="tabPosition" style="margin:10px 10% 0 0;display: inline-block; float:right;" @change="getData_tabPosition">
                <el-radio-button label="天">天</el-radio-button>
                <el-radio-button label="月">月</el-radio-button>
            ...
            <el-tab-pane label="睡眠变化图(h)" name="end">
              <div class="day" v-if="tabPosition == '天'">
                <span>按天查询:</span>
                <el-date-picker v-model="value1" type="daterange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_sleep"></el-date-picker>
              </div>
              <div class="month" v-if="tabPosition == '月'">
                <span>按月查询:</span>
                <el-date-picker v-model="value1" type="monthrange" :start-placeholder="dateStart" :end-placeholder="dateEnd" @change="getDevice_sleep"></el-date-picker>
              </div>
              <el-radio-group v-model="tabPosition" style="margin:10px 10% 0 0;display: inline-block; float:right;" @change="getData_tabPosition">
                <el-radio-button label="天">天</el-radio-button>
                <el-radio-button label="月">月</el-radio-button>
        ...
        <el-tab-pane label="人员信息" name="second">
          <div class="Add_Object">
            <div class="item">
              <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                <el-form-item label="人员名称"><el-input v-model="ruleForm.name" placeholder="请输入人员名称"></el-input></el-form-item>
                <el-form-item label="人员电话"><el-input type="number" v-model="ruleForm.memberTel" placeholder="请输入人员电话"></el-input></el-form-item>
                <el-form-item label="邮箱地址"><el-input type="text" v-model="ruleForm.memberEmail" placeholder="请输入邮箱地址"></el-input></el-form-item>
                <el-form-item label="紧急联系人"><el-input type="text" v-model="ruleForm.memberContactMan1Name" placeholder="紧急联系人"></el-input></el-form-item>
                <el-form-item label="紧急联系人电话"><el-input type="text" v-model="ruleForm.memberContactMan1Tel" placeholder="紧急联系人电话"></el-input></el-form-item>
                <el-form-item label="第二联系人"><el-input type="text" v-model="ruleForm.memberContactMan2Name" placeholder="第二联系人"></el-input></el-form-item>
                <el-form-item label="第二联系人电话"><el-input type="text" v-model="ruleForm.memberContactMan2Tel" placeholder="第二联系人电话"></el-input></el-form-item>
                ...
                <el-form-item label="设备编号"><el-input v-model="ruleForm.memberImei" placeholder="请输入设备编号"></el-input></el-form-item>
                <el-form-item label="人员地址"><v-distpicker :province="memberArea1" :city="memberArea2" :area="memberArea3" @selected="onSelected"></v-distpicker></el-form-item>
                <el-form-item label="人员详细地址"><el-input v-model="ruleForm.address" placeholder="请输入人员详细地址"></el-input></el-form-item>
                ...
                <el-form-item label="过往病史"><el-input type="textarea" v-model="ruleForm.desc" :rows="5" placeholder="请输入过往病史"></el-input></el-form-item>
                <el-form-item>
        ...
        <el-tab-pane label="历史评估" name="third">
          <div class="item">
        ...
        <el-tab-pane label="历史档案" name="fourth">
          <div class="item">
            <div class="memberAssess" style="overflow-x: hidden">
      ...
      <div slot="footer" class="dialog-footer" style="clear:both">
        ...
        <el-button type="primary" @click="delete_btn(memberInfo.ID)">删除监护对象</el-button>
      </div>
    </el-dialog>
      ...
      <div class="Add_Object">
        <div class="item">
          <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="120px" class="demo-ruleForm">
            <el-form-item label="医生名称" prop="name_doctor"><el-input v-model="ruleForm2.name_doctor" placeholder="请输入人员名称"></el-input></el-form-item>
            ...
            <el-form-item label="角色类型：">
              <el-select v-model="ruleForm2.memberRoleId" placeholder="请选择"><el-option key="3" label="医生" value="3"></el-option></el-select>
            </el-form-item>
            <el-form-item label="职位名称"><el-input type="text" v-model="ruleForm2.memberJob_doctor" placeholder="请输入职位名称"></el-input></el-form-item>
            <el-form-item label="人员地址"><v-distpicker :province="memberArea1" :city="memberArea2" :area="memberArea3" @selected="onSelected"></v-distpicker></el-form-item>
            <el-form-item label="人员详细地址" prop="address_doctor"><el-input v-model="ruleForm2.address_doctor" placeholder="请输入人员详细地址"></el-input></el-form-item>
            <el-form-item label="医生专长"><el-input type="textarea" v-model="ruleForm2.memberIntro1" :rows="4" placeholder="请输入医生简介"></el-input></el-form-item>
    ...
    <el-dialog title="选择人员" :visible.sync="isShow">
      <div>
        <el-form ref="form" :model="form" label-width="80px">
          <el-form-item label="人员名称"><el-input v-model="search_Input3" placeholder="请填写人员名称"></el-input></el-form-item>
        </el-form>
      </div>
      <div class="memberList" v-loading="loading2" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
        <ul>
          <li v-for="(item, index) in doctorList" :key="index" :class="{ bgcolor: list_index == index }" @click="getMember_item(index, item.MemberName, item.MemberTel)">
            {{ item.MemberName }}
          </li>
        </ul>
      </div>
    ...
    <el-dialog title="医生审核" :visible.sync="IsShow_AuditInfo">
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-form-item label="审核描述"><el-input type="textarea" :rows="4" v-model="AuditInfo.intro" placeholder="请输入审核描述"></el-input></el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      auditStatus: '',
      auditStatusList: [{ value: '0', label: '待审核' }, { value: '1', label: '已审核' }, { value: '2', label: '已拒绝' }],
      AuditInfo: {
        id: '',
        status: '',
        intro: ''
      ...
      rules: {
        ...
        memberTel: [{ required: true, message: '请输入人员电话', trigger: 'blur' }]
        // memberImei: [
      ...
      rules2: {
        name_doctor: [{ required: true, message: '请输入医生名称', trigger: 'blur' }],
        memberTel_doctor: [{ required: true, message: '请输入医生电话', trigger: 'blur' }],
        memberPwd_doctor: [{ required: true, message: '请输入账号密码', trigger: 'blur' }],
        memberJob_doctor: [{ required: true, message: '请输入工作职责', trigger: 'blur' }],
        address_doctor: [{ required: true, message: '请输人员详细地址', trigger: 'blur' }],
        memberIntro1: [{ required: true, message: '请输医生专长', trigger: 'blur' }],
        desc_doctor: [{ required: true, message: '请输医生简介', trigger: 'blur' }]
      }
    };
  },
  ...
  methods: {
    ...
    getMember_item(index, name, tel) {
      this.list_index = index;
      this.search_Input3 = name;
      this.ruleForm.memberContactMan3Name = name;
      this.ruleForm.memberContactMan3Tel = tel;
    },
    ...
    getDevice_Echert_ECG(data) {
      ...
      let option = {
        backgroundColor: 'rgba(43, 51, 90, 1)',
        calculable: true,
        tooltip: {
          trigger: 'axis'
        },
...
.container {
  ...
  /deep/ .container .Add_TutelageObject .Add_Object[data-v-3b034b1d] {
    background-color: rgba(43, 51, 90, 1) !important;
  ...
  .el-input-group__prepend {
    background-color:#3877d2 !important;
    color: #fff;
    border: 1px solid #ccc;
  }
}
